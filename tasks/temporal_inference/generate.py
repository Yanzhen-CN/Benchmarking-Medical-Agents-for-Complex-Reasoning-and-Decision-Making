...
- trajectory_sorting_question.py must run before trajectory_sorting_context.py
...
if __name__ == "__main__":
    ...
    run_script("trajectory_sorting_question.py", description="Generate trajectory sorting questions")
    run_script("trajectory_sorting_context.py",   description="Generate trajectory sorting context")
