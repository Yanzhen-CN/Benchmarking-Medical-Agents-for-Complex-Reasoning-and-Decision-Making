...
def store_fact(mem: Mem0MemoryProvider, text: str, *, user_id: str, agent_id: str, app_id: str, run_id: str) -> None:
    mem.add_memory(
        text=text,
        metadata={"type": "fact"},
        user_id=user_id,
...
def maybe_flush(mem: Mem0MemoryProvider, *, user_id: str, agent_id: str, app_id: str, run_id: str) -> None:
